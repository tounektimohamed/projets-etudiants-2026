...
import 'package:mymeds_app/screens/doctor_home.dart';
import 'package:mymeds_app/screens/doctor_patients.dart';
import 'package:mymeds_app/screens/doctor_prescriptions.dart';
import 'package:mymeds_app/screens/doctor_settings.dart';
...
class _DashboardDoctorState extends State<DashboardDoctor> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          translation(context).doctorSpaceTitle,
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(
            ...
            label: translation(context).prescriptionsNav,
            selectedIcon: const Icon(
              Icons.description,
              color: Color.fromRGBO(7, 82, 96, 1),
            ),
