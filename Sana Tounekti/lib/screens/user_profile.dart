...
class _UserProfileState extends State<UserProfile> {
    ...
    await FirebaseFirestore.instance
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Text(
            translation(context).dataUpdatedSuccess,
          ),
        ),
      );
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          translation(context).yourProfile,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      onTap: () async {
                        var datePicked = await DatePicker.showSimpleDatePicker(
                          context,
                          titleText: translation(context).selectBirthday,
                              ...
                              builder:
                                ...
                                return Column(
                                  ...
                                  children: <Widget>[
                                    RadioListTile(
                                      value: Genders.male,
                                      title: Text(translation(context).male),
                                    ...
                                    RadioListTile(
                                      ...
                                      title: Text(translation(context).female),
                                      groupValue: _genderSelected,
                                      onChanged: (Genders? vale) {
                                        setState(
                                          () {
                                    ...
                                    RadioListTile(
                                      value: Genders.other,
                                      title: Text(translation(context).other),
                                      groupValue: _genderSelected,
                                      onChanged: (Genders? vale) {
                                        setState(
                                          () {
                    ...
                    //nic
                    Text_Field(
                      label: translation(context).nic,
                      hint: translation(context).nicHint,
                      isPassword: false,
                      keyboard: TextInputType.text,
                    ...
                    Text_Field(
                      ...
                      hint: translation(context).addressHint,
                      isPassword: false,
                      keyboard: TextInputType.text,
                      txtEditController: _nicController,
                      focusNode: FocusNode(),
                    ...
                    //mobile
                    Text_Field(
                      label: translation(context).mobileNo,
                      hint: translation(context).mobileHint,
                      isPassword: false,
                      keyboard: TextInputType.text,
                      txtEditController: _nicController,
                      focusNode: FocusNode(),
