    ...
    if (isEmailVerified) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Text(
            translation(context).verifyEmailSuccess,
          ),
        ),
      );
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    translation(context).verifyEmailTitle,
                  ...
                  Text(
                    '${translation(context).verifyEmailDesc} ${FirebaseAuth.instance.currentUser?.email}',
                    style: GoogleFonts.roboto(
                      fontSize: 15,
                      height: 1.0,
                      color: const Color.fromARGB(255, 16, 15, 15),
                  ...
                  Text(
                    translation(context).verifyWaiting,
                    style: GoogleFonts.roboto(
                      fontSize: 15,
                      height: 1.0,
                      color: const Color.fromARGB(255, 16, 15, 15),
                        ...
                        child: GlowingOverscrollIndicator(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                translation(context).verifyLinkResent,
                                style: GoogleFonts.roboto(
                                  fontSize: 15,
                                  fontWeight: FontWeight.w600,
                                  color: const Color.fromARGB(238, 64, 93, 77),
                  ...
                  SizedBox(
                    ...
                    child: FilledButton(
                      ...
                      child: Text(
                        translation(context).verifyResendBtn,
                        style: GoogleFonts.roboto(
                          fontSize: 25,
                          fontWeight: FontWeight.w600,
                        ),
