...
class AddMedication1 extends StatefulWidget {
  ...
  AddMedication1({super.key, this.targetUserEmail});

  @override
  _AddMedication1State createState() => _AddMedication1State();
}

class _AddMedication1State extends State<AddMedication1> with TalkbackScreenMixin {
  ...
  void didChangeDependencies() {
    ...
    speakOnLoad('${translation(context).addMed}. ${translation(context).medName}, ${translation(context).cat}, ${translation(context).strength}. ${translation(context).next}');
  }
    ...
    if (_medicationNameController.text.isEmpty) {
      ...
      if (_medicationStrengthValueController.text.isNotEmpty &&
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AddMedication2(targetUserEmail: widget.targetUserEmail),
          ),
        );
      }
    }
