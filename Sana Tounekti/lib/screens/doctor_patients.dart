    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'Entrez l\'email du patient que vous souhaitez suivre. Une demande sera envoyée.',
            ...
            onPressed: () async {
              if (emailController.text.trim().isNotEmpty) {
                ...
                await FirebaseFirestore.instance
                    ...
                    .doc(targetEmail)
                    .update({
                  'pendingDoctorRequests': FieldValue.arrayUnion([user!.email]),
                });
  ...
  Future<void> _acceptRequest(String patientEmail) async {
    ...
    try {
      await FirebaseFirestore.instance
        ...
        'pendingDoctorRequests': FieldValue.arrayRemove([patientEmail]),
      });
      ...
      await FirebaseFirestore.instance
          ...
          .doc(patientEmail)
          .update({
        'linkedDoctorEmails': FieldValue.arrayUnion([user!.email]),
          ...
          child: Row(
            children: [
              CircleAvatar(
                ...
                child: Text(
                  (data['name']?.isNotEmpty == true ? data['name']![0] : 'P')
                      .toUpperCase(),
                  style: GoogleFonts.poppins(
                    fontSize: 40,
        ...
        builder: (context, scrollController) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow(
                  Icons.calendar_today, t.dob, data['dob'] ?? t.notProvided),
              const SizedBox(height: 24),
              Row(
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: Text(t.createPrescription),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color.fromRGBO(7, 82, 96, 1),
                        foregroundColor: Colors.white,
