...
class AddMedication2 extends StatefulWidget {
  ...
  AddMedication2({super.key, this.targetUserEmail});
...
class _AddMedication2State extends State<AddMedication2> with TalkbackScreenMixin {
  ...
  void didChangeDependencies() {
    ...
    speakOnLoad('${translation(context).addMed}. ${translation(context).dpi}, ${translation(context).apc}, ${translation(context).medNote}. ${translation(context).next}');
  }
    ...
    if (_medicationDosageController.text.isEmpty) {
      ...
      if (_medicationCountController.text.isNotEmpty &&
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AddMedication3(targetUserEmail: widget.targetUserEmail),
          ),
        );
      }
    }
