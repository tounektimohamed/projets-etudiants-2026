...
class _AddMedication4State extends State<AddMedication4> with TalkbackScreenMixin {
  //current user
  ...
  void didChangeDependencies() {
    ...
    speakOnLoad('${translation(context).addMed}. ${translation(context).summary}: ${translation(context).medName}, ${translation(context).cat}, ${translation(context).strength}, ${translation(context).medTimes}, ${translation(context).freq}, ${translation(context).sDate}, ${translation(context).eDate}');
  }
